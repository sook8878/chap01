	...
	public static void main(String[] args) {
		 ...
		 */
		 ...
		 //int result = num1 + num2; // 자동으로 큰 쪽 자료형인 long으로 변경 후
		                             // 계산되기 때문에 int형 변수에 값을 담을 수 없다.
		 
		 long result1 = num1 + num2; // int + long은 서로 다른 자료형이라 데이터 손실이 
		                             // 발생하지 않는 int -> long 변환을 자동 수행 후
		                             // 연산한다.
		  ...
		  * 실제 값을 저장하는 매커니즘을 가진 것과 달리 실수형은 지수부와 가수부를 따로 나눠서 
		  * 작성하기 때문에 바이트 크기 보다 휠씬 더 많은 값을 표현할 수 있다. 
		  */
		 
		  //long eight = 8888888888888888888; // 자동으로 형변환이 된것 (int범위 벗어나면 에러) 
		  long eight = 8;
		  float four = eight;
